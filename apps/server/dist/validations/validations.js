...
export const productVariantCreateSchema = z.object({
    ...
    image: z.string().url().optional(),
    isDefault: z.boolean().optional(),
    attributes: z.record(z.string(), z.string()).refine((val) => Object.keys(val).length >= 1, { message: "At least one attribute is required" }),
});
...
export const validateUser = (data) => userCreateSchema.parse(data);
export const validateUserUpdate = (data) => userUpdateSchema.parse(data);
export const validateProduct = (data) => productCreateSchema.parse(data);
export const validateProductUpdate = (data) => productUpdateSchema.parse(data);
export const validateOrder = (data) => orderCreateSchema.parse(data);
export const validateOrderUpdate = (data) => orderUpdateSchema.parse(data);
...
}).refine((data) => data.billingAddressSameAsShipping || data.billingAddress !== undefined, {
