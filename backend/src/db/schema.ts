...
export const accounts = pgTable(
  ...
  (account) => ({
    providerPk: uniqueIndex("provider_pk").on(
      account.provider,
...
export const productCategories = pgTable(
  ...
  (table) => ({
    ...
    productIdIdx: index("product_categories_product_id_idx").on(
      table.productId
    ),
...
export const attributeValues = pgTable(
  ...
  (table) => ({
    attributeIdIdx: index("attribute_values_attribute_id_idx").on(
      table.attributeId
    ),
  })
);
...
// =============================================
// SHOPPING RELATIONS (Carts, Wishlists)
// =============================================
