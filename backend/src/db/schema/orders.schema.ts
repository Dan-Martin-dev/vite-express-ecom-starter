...
import { PaymentResult, orderStatusEnum, paymentStatusEnum, ShippingAddress } from '../../types/index.js';

// Import related schemas for relations
import { users } from './auth.schema.js';
import { products, productVariants } from './products.schema.js';
import { reviews } from './reviews.schema.js'; // Needed for ordersRelations
