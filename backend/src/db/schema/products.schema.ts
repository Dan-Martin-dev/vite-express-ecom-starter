...
import { wishlistItems } from './wishlists.schema.js';
...
export const productVariantsRelations = relations(productVariants, ({ one, many }) => ({ // Added many for orderItems/wishlistItems
