...
import { UserCreateData, UserLoginData, PocketBaseAuthResponse } from './auth.types.js'; // Added .js extension
...
export class AuthService {
     ...
     */
    async registerUser(userData: UserCreateData) {
     ...
     */
    async loginUser(loginData: UserLoginData): Promise<PocketBaseAuthResponse> {
        try {
